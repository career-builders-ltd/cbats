  ...
  <div class="page-header-inner ">
    ...
    <div class="page-logo">
      <a href="{{asset('dashboard')}}">
        <img src="{{asset('images/cb-ats-logo.png')}}" alt="logo" class="logo-default" /> </a>
    ...
    <div class="page-actions">
      <div class="btn-group">
        ...
        <ul class="dropdown-menu" role="menu">
          <li>
            <a href="javascript:;">
              <i class="icon-docs"></i> New Candidate </a>
          </li>
          <li>
            <a href="javascript:;">
              <i class="icon-tag"></i> New Job Opening </a>
          </li>
          <li>
            <a href="javascript:;">
              ...
              <li>
                <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                  <li>
                    <a href="#">
                      <span class="photo">
                        <img src="{{asset('images/avatar2.jpg')}}" class="img-circle" alt="">
                      </span>
                      <span class="subject">
                  ...
                  <li>
                    <a href="#">
                      <span class="photo">
                        <img src="{{asset('images/avatar3.jpg')}}" class="img-circle" alt="">
                      </span>
                      <span class="subject">
                  ...
                  <li>
                    <a href="#">
                      <span class="photo">
                        <img src="{{asset('images/avatar1.jpg')}}" class="img-circle" alt="">
                      </span>
                      <span class="subject">
