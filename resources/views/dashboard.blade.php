<?php $nav_pos='_dashboard' ?>
@extends('layouts.base',['title'=>'Career Builders - Application Tracking System'])
...
<small>Application Tracking System</small>
</h1>
<div class="page-bar">
        ...
        <div class="tab-content">
          <div class="tab-pane active" id="portlet_comments_1">
            ...
            <div class="mt-comments">
              <div class="mt-comment">
                <div class="mt-comment-img"><img src="{{asset('images/users/avatar1.jpg')}}" /></div>
                <div class="mt-comment-body">
                  ...
                  <div class="mt-comment-details">
                    <span class="mt-comment-statu s mt-comment-status-pending">Pending</span>
              ...
              <div class="mt-comment">
                <div class="mt-comment-img">
                  <img src="{{asset('images/users/avatar6.jpg')}}" /> </div>
                <div class="mt-comment-body">
                  <div class="mt-comment-info">
              ...
              <div class="mt-comment">
                <div class="mt-comment-img">
                  <img src="{{asset('images/users/avatar8.jpg')}}" /> </div>
                <div class="mt-comment-body">
                  <div class="mt-comment-info">
              ...
              <div class="mt-comment">
                <div class="mt-comment-img">
                  <img src="{{asset('images/users/avatar4.jpg')}}" /> </div>
                <div class="mt-comment-body">
                  <div class="mt-comment-info">
          ...
          <div class="tab-pane" id="portlet_comments_2">
            ...
            <div class="mt-comments">
              ...
              <div class="mt-comment">
                <div class="mt-comment-img">
                  <img src="{{asset('images/users/avatar1.jpg')}}" /> </div>
                <div class="mt-comment-body">
                  <div class="mt-comment-info">
                    <span class="mt-comment-author">Sebastian Davidson</span>
                    <span class="mt-comment-date">10 Dec, 09:20 AM</span>
        ...
        <div class="tab-content">
            ...
            <div class="mt-actions">
              <div class="mt-action">
                <div class="mt-action-img">
                  <img src="{{asset('images/users/avatar10.jpg')}}" /> </div>
              ...
              <div class="mt-action">
                <div class="mt-action-img">
                  <img src="{{asset('images/users/avatar3.jpg')}}" /> </div>
                <div class="mt-action-body">
                  <div class="mt-action-row">
                    <div class="mt-action-info ">
                      <div class="mt-action-icon ">
              ...
              <div class="mt-action">
                <div class="mt-action-img">
                  <img src="{{asset('images/users/avatar2.jpg')}}" /> </div>
                <div class="mt-action-body">
                  <div class="mt-action-row">
                    <div class="mt-action-info ">
                      <div class="mt-action-icon ">
              ...
              <div class="mt-action">
                <div class="mt-action-img">
                  <img src="{{asset('images/users/avatar7.jpg')}}" /> </div>
                <div class="mt-action-body">
                  <div class="mt-action-row">
                    <div class="mt-action-info ">
                      <div class="mt-action-icon ">
              ...
              <div class="mt-action">
                <div class="mt-action-img">
                  <img src="{{asset('images/users/avatar9.jpg')}}" /> </div>
                <div class="mt-action-body">
                  <div class="mt-action-row">
                    <div class="mt-action-info ">
                      <div class="mt-action-icon ">
          ...
          <div class="tab-pane" id="tab_actions_completed">
            ...
            <div class="mt-actions">
              ...
              <div class="mt-action">
                <div class="mt-action-img">
                  <img src="{{asset('images/users/avatar5.jpg')}}" /> </div>
                <div class="mt-action-body">
                  <div class="mt-action-row">
                    <div class="mt-action-info ">
                      <div class="mt-action-icon ">
          ...
          <div class="events-content">
            <ol>
              <li class="selected" data-date="16/01/2014">
                ...
                <div class="mt-author">
                  <div class="mt-avatar">
                    <img src="{{asset('images/users/avatar80_3.jpg')}}" />
                  </div>
                ...
                <div class="mt-content border-grey-steel">
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam euismod eleifend ipsum, at posuere augue. Pellentesque mi felis, aliquam at iaculis eu, mi felis, aliquam at iaculis mi felis, aliquam at iaculis finibus eu ex. Integer efficitur
                    tincidunt malesuada. Sed sit amet molestie elit, vel placerat ipsum. Ut consectetur odio non est rhoncus volutpat.</p>
              ...
              <li data-date="28/02/2014">
                ...
                <div class="clearfix"></div>
                <div class="mt-content border-grey-steel">
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam euismod eleifend ipsum, at posuere augue. Pellentesque mi felis, aliquam at iaculis eu, finibus eu ex. Integer efficitur leo eget dolor tincidunt, et dignissim risus lacinia.
                    Nam in egestas nunc. Suspendisse potenti. Cras ullamcorper tincidunt malesuada. Sed sit amet molestie elit, vel placerat ipsum. Ut consectetur odio non est rhoncus volutpat. Nullam interdum, neque quis vehicula ornare, lacus elit dignissim
                    purus, quis ultrices erat tortor eget felis. Cras commodo id massa at condimentum. Praesent dignissim luctus risus sed sodales.</p>
...
<i class="fa fa-angle-down"></i>
              ...
              <li data-date="20/04/2014">
                ...
                <div class="mt-author">
                  <div class="mt-avatar">
                    <img src="{{asset('images/users/avatar80_1.jpg')}}" />
                  </div>
                  <div class="mt-author-name">
                ...
                <div class="mt-content border-grey-steel">
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam euismod eleifend ipsum, at posuere augue. Pellentesque mi felis, aliquam at iaculis eu, finibus eu ex. Integer efficitur leo eget dolor tincidunt, et dignissim risus lacinia.
                    Nam in egestas nunc. Suspendisse potenti. Cras ullamcorper tincidunt malesuada. Sed sit amet molestie elit, vel placerat ipsum. Ut consectetur odio non est rhoncus volutpat. Nullam interdum, neque quis vehicula ornare, lacus elit dignissim
                    purus, quis ultrices erat tortor eget felis. Cras commodo id massa at condimentum. Praesent dignissim luctus risus sed sodales.</p>
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto, optio, dolorum provident rerum aut hic quasi placeat iure tempora laudantium ipsa ad debitis unde? Iste voluptatibus minus veritatis qui ut. laudantium ipsa ad debitis
              ...
              <li data-date="20/05/2014">
                ...
                <div class="mt-author">
                  <div class="mt-avatar">
                    <img src="{{asset('images/users/avatar80_2.jpg')}}" />
                  </div>
                  <div class="mt-author-name">
                    <a href="javascript:;" class="font-blue-madison">Andres Iniesta</a>
                  </div>
...
<i class="fa fa-angle-down"></i>
              ...
              <li data-date="30/08/2014">
                ...
                <div class="clearfix"></div>
                <div class="mt-content border-grey-steel">
                  <img class="timeline-body-img pull-left" src="{{asset('images/blog/5.jpg')}}" alt="">
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto, optio, dolorum provident rerum aut hic quasi placeat iure tempora laudantium ipsa ad debitis unde? Iste voluptatibus minus veritatis qui ut. laudantium ipsa ad debitis
                    unde? Iste voluptatibus minus veritatis qui ut. </p>
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto, optio, dolorum provident rerum aut hic quasi placeat iure tempora laudantium ipsa ad debitis unde? Iste voluptatibus minus veritatis qui ut. laudantium ipsa ad debitis
                    unde? Iste voluptatibus minus veritatis qui ut. </p>
              ...
              <li data-date="15/09/2014">
                ...
                <div class="mt-author">
                  <div class="mt-avatar">
                    <img src="{{asset('images/users/avatar80_5.jpg')}}" />
                  </div>
                  <div class="mt-author-name">
                ...
                <div class="clearfix"></div>
                <div class="mt-content border-grey-steel">
                  <img class="timeline-body-img pull-right" src="{{asset('images/blog/6.jpg')}}" alt="">
          ...
          <div class="events-content">
            <ol>
              <li class="selected" data-date="16/01/2014">
                ...
                <div class="clearfix"></div>
                <div class="mt-content border-grey-steel">
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam euismod mi felis, aliquam at iaculis eleifend ipsum, at posuere augue. Pellentesque mi felis, aliquam at iaculis mi felis, aliquam at iaculis eu, onsectetur adipiscing elit
                    finibus eu ex. Integer efficitur leo eget dolor tincidunt, et dignissim risus lacinia. Nam in egestas onsectetur adipiscing elit nunc. Suspendisse potenti</p>
      ...
      <div class="portlet-body">
        ...
        <div class="table-scrollable table-scrollable-borderless">
          <table class="table table-hover table-light">
            ...
            <tr>
              <td class="fit">
                <img class="user-pic rounded" src="{{asset('images/users/avatar4.jpg')}}"> </td>
              <td>
            ...
            <tr>
              <td class="fit">
                <img class="user-pic rounded" src="{{asset('images/users/avatar5.jpg')}}"> </td>
              <td>
            ...
            <tr>
              <td class="fit">
                <img class="user-pic rounded" src="{{asset('images/users/avatar6.jpg')}}"> </td>
              <td>
            ...
            <tr>
              <td class="fit">
                <img class="user-pic rounded" src="{{asset('images/users/avatar7.jpg')}}"> </td>
              <td>
        ...
        <div class="scroller" style="height: 338px;" data-always-visible="1" data-rail-visible1="0" data-handle-color="#D7DCE2">
          <div class="general-item-list">
            <div class="item">
              <div class="item-head">
                <div class="item-details">
                  <img class="item-pic rounded" src="{{asset('images/users/avatar4.jpg')}}">
            ...
            <div class="item">
              <div class="item-head">
                <div class="item-details">
                  <img class="item-pic rounded" src="{{asset('images/users/avatar3.jpg')}}">
            ...
            <div class="item">
              <div class="item-head">
                <div class="item-details">
                  <img class="item-pic rounded" src="{{asset('images/users/avatar6.jpg')}}">
                  <a href="#" class="item-name primary-link">Nick Larson</a>
            ...
            <div class="item">
              <div class="item-head">
                <div class="item-details">
                  <img class="item-pic rounded" src="{{asset('images/users/avatar7.jpg')}}">
                  <a href="#" class="item-name primary-link">Nick Larson</a>
            ...
            <div class="item">
              <div class="item-head">
                <div class="item-details">
                  <img class="item-pic rounded" src="{{asset('images/users/avatar9.jpg')}}">
            ...
            <div class="item">
              <div class="item-head">
                <div class="item-details">
                  <img class="item-pic rounded" src="{{asset('images/users/avatar8.jpg')}}">
            ...
            <div class="item">
              <div class="item-head">
                <div class="item-details">
                  <img class="item-pic rounded" src="{{asset('images/users/avatar2.jpg')}}">
                  <a href="#" class="item-name primary-link">Larry</a>
                  <span class="item-label">4 hrs ago
                          </span>
                </div>
                <span class="item-status">
                          <span class="badge badge-empty badge-success"></span> Open
    ...
    <div class="portlet light ">
      ...
      <div class="portlet-body">
        <div id="region_statistics_loading">
          <img src="{{asset('images/loading.gif')}}" alt="loading" /> </div>
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <div class="mt-widget-1">
              ...
              <div class="mt-img">
                <img src="{{asset('images/users/avatar80_8.jpg')}}"> </div>
              <div class="mt-body">
          ...
          <div class="col-md-4">
            ...
            <div class="mt-widget-1">
              ...
              <div class="mt-img">
                <img src="{{asset('images/users/avatar80_7.jpg')}}"> </div>
              <div class="mt-body">
          ...
          <div class="col-md-4">
            ...
            <div class="mt-widget-1">
              ...
              <div class="mt-img">
                <img src="{{asset('images/users/avatar80_6.jpg')}}"> </div>
              <div class="mt-body">
        ...
        <div class="actions">
          <div class="btn-group btn-group-devided" data-toggle="buttons">
            <label class="btn red btn-outline btn-circle btn-sm active">
                      <input type="radio" name="options" class="toggle" id="option1">Settings
                    </label>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="mt-widget-2">
              <div class="mt-head" style="background-image: url({{asset('images//background/32.jpg')}});">
                <div class="mt-head-label">
                  <button type="button" class="btn btn-success">Manhattan</button>
                </div>
                <div class="mt-head-user">
                  <div class="mt-head-user-img">
                    <img src="{{asset('images//avatars/team7.jpg')}}"> </div>
          ...
          <div class="col-md-6">
            <div class="mt-widget-2">
              <div class="mt-head" style="background-image: url({{asset('images//background/43.jpg')}});">
                <div class="mt-head-label">
                  <button type="button" class="btn btn-danger">London</button>
                </div>
                <div class="mt-head-user">
                  <div class="mt-head-user-img">
                    <img src="{{asset('images//avatars/team3.jpg')}}"> </div>
                  <div class="mt-head-user-info">
      ...
      <div class="portlet-body">
        <div class="row">
          <div class="col-md-4">
            <div class="mt-widget-4">
              <div class="mt-img-container">
                <img src="{{asset('images//background/34.jpg')}}" /> </div>
          ...
          <div class="col-md-4">
            <div class="mt-widget-4">
              <div class="mt-img-container">
                <img src="{{asset('images//background/46.jpg')}}" /> </div>
          ...
          <div class="col-md-4">
            <div class="mt-widget-4">
              <div class="mt-img-container">
                <img src="{{asset('images/background/37.jpg')}}" /> </div>
          ...
          <div class="col-md-4">
            <div class="mt-widget-3">
              ...
              <div class="mt-body-actions-icons">
                <div class="btn-group btn-group btn-group-justified">
                  <a href="javascript:;" class="btn ">
                    <span class="mt-icon"><i class="glyphicon glyphicon-align-justify"></i>
                            </span>RECORD
                  </a>
                  <a href="javascript:;" class="btn ">
                    <span class="mt-icon">
